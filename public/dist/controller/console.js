...
layui.define(function(exports){
  ...
  */
  ...
  //区块轮播切换
  layui.use(['admin', 'carousel','selfajax'], function(){
    var $ = layui.$
    ,admin = layui.admin
    ...
    // selfajax.ajax('/admin/getCommentReview','get',{}, function(res){
    //   console.log(res)
    //   $('#jdt').html(res.data.jdtnum);
    //   $('#wd').html(res.data.wdnum);
    //   $('#md').html(res.data.mdnum);
    //   $('#pop').html(res.data.popnum);
    //   $('#s8').html(res.data.s8num);
    //   $('#wdht').html(res.data.wdpostnum);
    // }, '',function(){
    //   loading = layer.load();
    // },function () {
    //   layer.close(loading);
