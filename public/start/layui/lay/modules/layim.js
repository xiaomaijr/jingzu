...
;layui.define(["layer", "laytpl", "upload"], function (i) {
    var a = "3.9.1", e = layui.$, t = layui.layer, n = layui.laytpl, l = layui.device(), s = "layui-show",
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        a.scrollTop(a[0].scrollHeight + 1e3), a.find("ul li:last").find("img").on('load',function () {
